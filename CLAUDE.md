...
предложения этого этапа в GetCourse заведены не у всех (25.08 — 16 воронок из
76, 01.09 — 33 из 77 плюс одна связка, под которую воронки в базе нет), и это
расхождение разбирает аудит, а не схема. Числа тут — замеры по снимкам реестра,
а не свойство модели: они растут каждую неделю.
