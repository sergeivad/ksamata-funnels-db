...
// «Номер» рядом с «Код» читалось как второй номер воронки, хотя это внутренний
// ключ базы и с F-кодом не связан. Осталось как ID — по нему сходятся строки
// одной воронки и склеиваются выгрузки, но номером его больше никто не примет.
